package com.example.yanmi.baidudemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    private BDAbstractLocationListener myListener = new BDAbstractLocationListener(){
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            tv1.setText("经度："+longitude+"   维度："+latitude);
            ...
            Log.d(TAG, "onReceiveLocation错误码: "+errorCode);
            tv2.setText(addr);
        }
    };
    ...
    PermissionsUtils.IPermissionsResult permissionsResult = new PermissionsUtils.IPermissionsResult() {
        ...
        public void passPermissons() {
            Toast.makeText(MainActivity.this, "权限通过，可以定位了", Toast.LENGTH_SHORT).show();
        }
